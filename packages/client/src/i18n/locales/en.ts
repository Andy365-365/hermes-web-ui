export default {
  ...
  profiles: {
    ...
    thinkingAnimation: {
      title: 'Custom Thinking Animation',
      customize: 'Animation',
      upload: 'Upload File',
      save: 'Save',
      reset: 'Use Default',
      hint: 'GIF, WebP, MP4, or WebM. Max 5MB.',
      invalidType: 'Please choose a GIF, WebP, MP4, WebM, or image file',
      tooLarge: 'Animation file must be 5MB or smaller',
      saveSuccess: 'Thinking animation saved',
      saveFailed: 'Failed to save thinking animation',
      resetSuccess: 'Default thinking animation restored',
      resetFailed: 'Failed to restore default thinking animation',
